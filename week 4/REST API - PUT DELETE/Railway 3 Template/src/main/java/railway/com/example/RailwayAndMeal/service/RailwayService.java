...
import railway.com.example.RailwayAndMeal.exceptions.*;
...
public class RailwayService {
	...
	**/
		if(ticketMap.containsKey(ticket.pnr)) {
			throw new TicketAlreadyExistsException("Ticket already exist for the pnr: "+ticket.pnr);
		}
		list.add(ticket);
